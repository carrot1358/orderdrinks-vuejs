...
<template>
                                ...
                                <VRow>
                                    ...
                                    <VCol cols="12">
                                        <VBtn
                                            ...
                                            block
                                            :disabled="
                                                addNotifyForm.name.length < 1 ||
                                                addNotifyForm.apiKeys.length < 5
                                            "
                                        >
                                            Create Key
                                        </VBtn>
                        ...
                        <VRow>
                            ...
                            >
                                ...
                                <VBtn
                                    ...
                                    variant="tonal"
                                    class="mx-2"
                                    @click="deleteLineNotify(item.token)"
                                >
                                    Delete</VBtn
                                >
                            </VCol>
    ...
    <VDialog v-model="editDialog" max-width="500px">
        <VCard>
            <VCardTitle> Edit Line Notify </VCardTitle>
            <VCardText>
                <VForm>
                    <VTextField
                        label="Notify Token"
                        v-model="editForm.newNotifyToken"
                    />
                    <VTextField
                        label="Notify Name"
                        v-model="editForm.notifyName"
                    />
                    <VCheckbox
                        label="Send Link"
                        v-model="editForm.isSendLink"
                    />
                </VForm>
            </VCardText>
            <VCardActions>
                <VSpacer />
                <VBtn color="blue darken-1" text @click="editDialog = false"
                    >Close</VBtn
                >
                <VBtn color="blue darken-1" text @click="submitEditForm"
                    >Save</VBtn
                >
            </VCardActions>
        </VCard>
